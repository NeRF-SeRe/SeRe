...
from sere.ngp.provider import NeRFDataset
from sere.ngp.gui import NeRFGUI
from sere.ngp.utils import *
...
if __name__ == '__main__':
    ...
    if opt.ff:
        ...
        from sere.ngp.network_ff import NeRFNetwork
    elif opt.tcnn:
        opt.fp16 = True
        assert opt.bg_radius <= 0, "background model is not implemented for --tcnn"
        from sere.ngp.network_tcnn import NeRFNetwork
    else:
        from sere.ngp.network import NeRFNetwork
    ...
    if opt.test:
        ...
        if opt.gui:
            ...
            trainer.test(test_loader, write_video=opt.video) # test and save video
