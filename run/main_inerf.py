...
import skimage
import cv2
from sere.inerf.utils import config_parser, load_blender, show_img, find_POI, img2mse, load_llff_data,load_replica
from sere.inerf.nerf_helpers import load_nerf
from sere.inerf.render_helpers import render, to8b, get_rays
from sere.inerf.inerf_helpers import camera_transf
import tqdm
...
def run():
    ...
    if dataset_type == 'replica':
        obs_img, hwf, start_pose, obs_img_pose = load_replica(args.data_dir, model_name, obs_img_num,
