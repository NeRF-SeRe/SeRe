...
def load_replica(basedir, model_name, obs_img_num, half_res, white_bkgd, *kwargs):
    ...
    #Process train_data
    frames = frames_all[obs_img_num:obs_img_num+1]
    pose = None
    image = None

    for f in tqdm.tqdm(frames,  'Loading data'):
    ...
    if white_bkgd:
        img_rgb = image[..., :3] * image[..., -1:] + (1. - image[..., -1:])
    else:
        img_rgb = image[..., :3]
